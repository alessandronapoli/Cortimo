...
X_t = [zeros(size(X_tPOS));[0,diff(X_tPOS(1,:)).*deltaTime];[0,diff(X_tPOS(2,:)).*deltaTime];ones(1,size(X_tPOS,2))];
...
%% Check for Kalman gain stability see 
% http://citeseerx.ist.psu.edu/viewdoc/download;jsessionid=AD6B949003B3686D20CE9D112E6F0A6C?doi=10.1.1.18.6534&rep=rep1&type=pdf
