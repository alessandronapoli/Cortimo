function [tVec,ff,ElbData,ElbZdata,HanData,HanZdata] = OnlineFeatureAnalysis_LFP_3(ff)
...
[fileList,pathT] = uigetfile('*.bin','Select training file with LFP data','MultiSelect',...
    'on');
...
if(isempty(EEGfeats) || isempty(VRTrainingLabels))
   return; 
end
%%
tp = EEGfeats{1,4};
